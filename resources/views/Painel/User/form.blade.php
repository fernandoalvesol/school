...
<div class="form-group{{ $errors->has('bibliografy') ? ' has-error' : '' }}">

    <div class="col-md-12">
        {{Form::textarea('bibliografy', null, ['class' => 'form-control', 'placeholder' => 'Bibliografia'])}}

        @if ($errors->has('bibliografy'))
        <span class="help-block">
            <strong>{{ $errors->first('bibliografy') }}</strong>
        </span>
        @endif
    </div>
</div>